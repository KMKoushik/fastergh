...
*/
export class AppPermissionsArtifactMetadata extends S.Literal("read", "write") {}
...
*/
export class AppPermissionsCustomPropertiesForOrganizations extends S.Literal("read", "write") {}
...
*/
export class AppPermissionsEnterpriseCustomPropertiesForOrganizations extends S.Literal("read", "write", "admin") {}
...
* The level of permission to grant the access token to create and retrieve build artifact metadata records.
*/
"artifact_metadata": S.optionalWith(AppPermissionsArtifactMetadata, { nullable: true }),
  /**
* The level of permission to create and retrieve the access token for repository attestations.
*/
...
* The level of permission to grant the access token to view and edit custom properties for an organization, when allowed by the property.
*/
"custom_properties_for_organizations": S.optionalWith(AppPermissionsCustomPropertiesForOrganizations, { nullable: true }),
  /**
* The level of permission to grant the access token for organization teams and members.
*/
...
* The level of permission to grant the access token for organization custom properties management at the enterprise level.
*/
"enterprise_custom_properties_for_organizations": S.optionalWith(AppPermissionsEnterpriseCustomPropertiesForOrganizations, { nullable: true })
}) {}
...
*/
export class RepositoryPullRequestCreationPolicy extends S.Literal("all", "collaborators_only") {}
...
*/
"has_pull_requests": S.optionalWith(S.Boolean, { nullable: true, default: () => true as const }),
  /**
* The policy controlling who can create pull requests: all or collaborators_only.
*/
"pull_request_creation_policy": S.optionalWith(RepositoryPullRequestCreationPolicy, { nullable: true }),
  /**
...
* The policy controlling who can create pull requests: all or collaborators_only.
*/
export class FullRepositoryPullRequestCreationPolicy extends S.Literal("all", "collaborators_only") {}

/**
* The policy controlling who can create pull requests: all or collaborators_only.
*/
export class NullableRepositoryPullRequestCreationPolicy extends S.Literal("all", "collaborators_only") {}
...
* The policy controlling who can create pull requests: all or collaborators_only.
*/
"pull_request_creation_policy": S.optionalWith(NullableRepositoryPullRequestCreationPolicy, { nullable: true }),
  /**
* Whether the repository is archived.
*/
"archived": S.Boolean.pipe(S.propertySignature, S.withConstructorDefault(() => false as const)),
...
export class SecurityAndAnalysisSecretScanningDelegatedAlertDismissalStatus extends S.Literal("enabled", "disabled") {}

export class SecurityAndAnalysisSecretScanningDelegatedBypassStatus extends S.Literal("enabled", "disabled") {}
...
"status": S.optionalWith(SecurityAndAnalysisDependabotSecurityUpdatesStatus, { nullable: true })
  ...
  "secret_scanning_delegated_alert_dismissal": S.optionalWith(S.Struct({
  "status": S.optionalWith(SecurityAndAnalysisSecretScanningDelegatedAlertDismissalStatus, { nullable: true })
}), { nullable: true }),
  "secret_scanning_delegated_bypass": S.optionalWith(S.Struct({
  "status": S.optionalWith(SecurityAndAnalysisSecretScanningDelegatedBypassStatus, { nullable: true })
}), { nullable: true }),
...
* The policy controlling who can create pull requests: all or collaborators_only.
*/
"pull_request_creation_policy": S.optionalWith(FullRepositoryPullRequestCreationPolicy, { nullable: true }),
  "archived": S.Boolean,
  /**
* Returns whether or not this repository disabled.
*/
...
* The ownership type of the team
*/
export class NullableTeamSimpleType extends S.Literal("enterprise", "organization") {}
...
*/
export class NullablePinnedIssueComment extends S.Class<NullablePinnedIssueComment>("NullablePinnedIssueComment")({
  "pinned_at": S.String,
...
*/
export class NullableIssueComment extends S.Class<NullableIssueComment>("NullableIssueComment")({
  /**
...
* The policy controlling who can create pull requests: all or collaborators_only.
*/
export class MinimalRepositoryPullRequestCreationPolicy extends S.Literal("all", "collaborators_only") {}
...
* The policy controlling who can create pull requests: all or collaborators_only.
*/
"pull_request_creation_policy": S.optionalWith(MinimalRepositoryPullRequestCreationPolicy, { nullable: true }),
...
*/
readonly "appsCreateInstallationAccessToken": (installationId: string, options: { readonly params?: typeof AppsCreateInstallationAccessTokenParams.Encoded | undefined; readonly payload: typeof AppsCreateInstallationAccessTokenRequest.Encoded }) => Effect.Effect<typeof InstallationToken.Type, HttpClientError.HttpClientError | ParseError | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"ValidationError", typeof ValidationError.Type>>
  /**
...
*/
readonly "reposGet": (owner: string, repo: string, options?: typeof ReposGetParams.Encoded | undefined) => Effect.Effect<typeof FullRepository.Type | typeof BasicError.Type, HttpClientError.HttpClientError | ParseError | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"BasicError", typeof BasicError.Type>>
  /**
* List branches
*/
readonly "reposListBranches": (owner: string, repo: string, options?: typeof ReposListBranchesParams.Encoded | undefined) => Effect.Effect<typeof ReposListBranches200.Type, HttpClientError.HttpClientError | ParseError | GitHubClientError<"BasicError", typeof BasicError.Type>>
  /**
...
*/
readonly "pullsList": (owner: string, repo: string, options?: typeof PullsListParams.Encoded | undefined) => Effect.Effect<typeof PullsList200.Type, HttpClientError.HttpClientError | ParseError | GitHubClientError<"ValidationError", typeof ValidationError.Type>>
  /**
...
*/
readonly "pullsGet": (owner: string, repo: string, pullNumber: string, options?: typeof PullsGetParams.Encoded | undefined) => Effect.Effect<typeof PullRequest.Type, HttpClientError.HttpClientError | ParseError | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"PullsGet503", typeof PullsGet503.Type>>
  /**
* Merges a pull request into the base branch.
* This endpoint triggers [notifications](https://docs.github.com/github/managing-subscriptions-and-notifications-on-github/about-notifications). Creating content too quickly using this endpoint may result in secondary rate limiting. For more information, see "[Rate limits for the API](https://docs.github.com/rest/using-the-rest-api/rate-limits-for-the-rest-api#about-secondary-rate-limits)" and "[Best practices for using the REST API](https://docs.github.com/rest/guides/best-practices-for-using-the-rest-api)."
*/
readonly "pullsMerge": (owner: string, repo: string, pullNumber: string, options: { readonly params?: typeof PullsMergeParams.Encoded | undefined; readonly payload: typeof PullsMergeRequest.Encoded }) => Effect.Effect<typeof PullRequestMergeResult.Type, HttpClientError.HttpClientError | ParseError | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"PullsMerge405", typeof PullsMerge405.Type> | GitHubClientError<"PullsMerge409", typeof PullsMerge409.Type> | GitHubClientError<"ValidationError", typeof ValidationError.Type>>
  /**
...
* - **`application/vnd.github-commitcomment.full+json`**: Returns raw, text, and HTML representations. Response will include `body`, `body_text`, and `body_html`.
*/
readonly "pullsCreateReview": (owner: string, repo: string, pullNumber: string, options: { readonly params?: typeof PullsCreateReviewParams.Encoded | undefined; readonly payload: typeof PullsCreateReviewRequest.Encoded }) => Effect.Effect<typeof PullRequestReview.Type, HttpClientError.HttpClientError | ParseError | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"ValidationErrorSimple", typeof ValidationErrorSimple.Type>>
  /**
...
* - **`application/vnd.github-commitcomment.full+json`**: Returns raw, text, and HTML representations. Response will include `body`, `body_text`, and `body_html`.
*/
readonly "pullsCreateReviewComment": (owner: string, repo: string, pullNumber: string, options: { readonly params?: typeof PullsCreateReviewCommentParams.Encoded | undefined; readonly payload: typeof PullsCreateReviewCommentRequest.Encoded }) => Effect.Effect<typeof PullRequestReviewComment.Type, HttpClientError.HttpClientError | ParseError | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"ValidationError", typeof ValidationError.Type>>
  /**
...
* - **`application/vnd.github-commitcomment.full+json`**: Returns raw, text, and HTML representations. Response will include `body`, `body_text`, and `body_html`.
*/
readonly "pullsCreateReplyForReviewComment": (owner: string, repo: string, pullNumber: string, commentId: string, options: { readonly params?: typeof PullsCreateReplyForReviewCommentParams.Encoded | undefined; readonly payload: typeof PullsCreateReplyForReviewCommentRequest.Encoded }) => Effect.Effect<typeof PullRequestReviewComment.Type, HttpClientError.HttpClientError | ParseError | GitHubClientError<"BasicError", typeof BasicError.Type>>
  /**
...
* - **`application/vnd.github.full+json`**: Returns raw, text, and HTML representations. Response will include `body`, `body_text`, and `body_html`.
*/
readonly "pullsListFiles": (owner: string, repo: string, pullNumber: string, options?: typeof PullsListFilesParams.Encoded | undefined) => Effect.Effect<typeof PullsListFiles200.Type, HttpClientError.HttpClientError | ParseError | GitHubClientError<"ValidationError", typeof ValidationError.Type> | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"PullsListFiles503", typeof PullsListFiles503.Type>>
  /**
* Updates the pull request branch with the latest upstream changes by merging HEAD from the base branch into the pull request branch.
* Note: If making a request on behalf of a GitHub App you must also have permissions to write the contents of the head repository.
*/
readonly "pullsUpdateBranch": (owner: string, repo: string, pullNumber: string, options: { readonly params?: typeof PullsUpdateBranchParams.Encoded | undefined; readonly payload: typeof PullsUpdateBranchRequest.Encoded }) => Effect.Effect<typeof PullsUpdateBranch202.Type, HttpClientError.HttpClientError | ParseError | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"ValidationError", typeof ValidationError.Type>>
  /**
...
* - **`application/vnd.github.full+json`**: Returns raw, text, and HTML representations. Response will include `body`, `body_text`, and `body_html`.
*/
readonly "issuesListForRepo": (owner: string, repo: string, options?: typeof IssuesListForRepoParams.Encoded | undefined) => Effect.Effect<typeof IssuesListForRepo200.Type | typeof BasicError.Type, HttpClientError.HttpClientError | ParseError | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"ValidationError", typeof ValidationError.Type>>
  /**
...
* - **`application/vnd.github.full+json`**: Returns raw, text, and HTML representations. Response will include `body`, `body_text`, and `body_html`.
*/
readonly "issuesCreate": (owner: string, repo: string, options: { readonly params?: typeof IssuesCreateParams.Encoded | undefined; readonly payload: typeof IssuesCreateRequest.Encoded }) => Effect.Effect<typeof Issue.Type, HttpClientError.HttpClientError | ParseError | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"ValidationError", typeof ValidationError.Type> | GitHubClientError<"IssuesCreate503", typeof IssuesCreate503.Type>>
  /**
...
* - **`application/vnd.github.full+json`**: Returns raw, text, and HTML representations. Response will include `body`, `body_text`, and `body_html`.
*/
readonly "issuesGet": (owner: string, repo: string, issueNumber: string, options?: typeof IssuesGetParams.Encoded | undefined) => Effect.Effect<typeof Issue.Type | typeof BasicError.Type, HttpClientError.HttpClientError | ParseError | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"BasicError", typeof BasicError.Type>>
  /**
...
* - **`application/vnd.github.full+json`**: Returns raw, text, and HTML representations. Response will include `body`, `body_text`, and `body_html`.
*/
readonly "issuesUpdate": (owner: string, repo: string, issueNumber: string, options: { readonly params?: typeof IssuesUpdateParams.Encoded | undefined; readonly payload: typeof IssuesUpdateRequest.Encoded }) => Effect.Effect<typeof Issue.Type | typeof BasicError.Type, HttpClientError.HttpClientError | ParseError | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"ValidationError", typeof ValidationError.Type> | GitHubClientError<"IssuesUpdate503", typeof IssuesUpdate503.Type>>
  /**
...
* - **`application/vnd.github.full+json`**: Returns raw, text, and HTML representations. Response will include `body`, `body_text`, and `body_html`.
*/
readonly "issuesListComments": (owner: string, repo: string, issueNumber: string, options?: typeof IssuesListCommentsParams.Encoded | undefined) => Effect.Effect<typeof IssuesListComments200.Type, HttpClientError.HttpClientError | ParseError | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"BasicError", typeof BasicError.Type>>
  /**
...
* - **`application/vnd.github.full+json`**: Returns raw, text, and HTML representations. Response will include `body`, `body_text`, and `body_html`.
*/
readonly "issuesCreateComment": (owner: string, repo: string, issueNumber: string, options: { readonly params?: typeof IssuesCreateCommentParams.Encoded | undefined; readonly payload: typeof IssuesCreateCommentRequest.Encoded }) => Effect.Effect<typeof IssueComment.Type, HttpClientError.HttpClientError | ParseError | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"ValidationError", typeof ValidationError.Type>>
  /**
* Lists all labels for an issue.
*/
readonly "issuesListLabelsOnIssue": (owner: string, repo: string, issueNumber: string, options?: typeof IssuesListLabelsOnIssueParams.Encoded | undefined) => Effect.Effect<typeof IssuesListLabelsOnIssue200.Type | typeof BasicError.Type, HttpClientError.HttpClientError | ParseError | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"BasicError", typeof BasicError.Type>>
  /**
* Adds labels to an issue.
*/
readonly "issuesAddLabels": (owner: string, repo: string, issueNumber: string, options: { readonly params?: typeof IssuesAddLabelsParams.Encoded | undefined; readonly payload: typeof IssuesAddLabelsRequest.Encoded }) => Effect.Effect<typeof IssuesAddLabels200.Type | typeof BasicError.Type, HttpClientError.HttpClientError | ParseError | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"ValidationError", typeof ValidationError.Type>>
  /**
* Removes the specified label from the issue, and returns the remaining labels on the issue. This endpoint returns a `404 Not Found` status if the label does not exist.
*/
readonly "issuesRemoveLabel": (owner: string, repo: string, issueNumber: string, name: string, options?: typeof IssuesRemoveLabelParams.Encoded | undefined) => Effect.Effect<typeof IssuesRemoveLabel200.Type | typeof BasicError.Type, HttpClientError.HttpClientError | ParseError | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"BasicError", typeof BasicError.Type>>
  /**
...
*/
readonly "reposListCommits": (owner: string, repo: string, options?: typeof ReposListCommitsParams.Encoded | undefined) => Effect.Effect<typeof ReposListCommits200.Type, HttpClientError.HttpClientError | ParseError | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"BasicError", typeof BasicError.Type>>
  /**
...
*/
readonly "gitGetTree": (owner: string, repo: string, treeSha: string, options?: typeof GitGetTreeParams.Encoded | undefined) => Effect.Effect<typeof GitTree.Type, HttpClientError.HttpClientError | ParseError | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"ValidationError", typeof ValidationError.Type>>
  /**
...
*/
readonly "reposGetContent": (owner: string, repo: string, path: string, options?: typeof ReposGetContentParams.Encoded | undefined) => Effect.Effect<typeof ReposGetContent200.Type, HttpClientError.HttpClientError | ParseError | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"BasicError", typeof BasicError.Type>>
  /**
* Repositories can have multiple webhooks installed. Each webhook should have a unique `config`. Multiple webhooks can
* share the same `config` as long as those webhooks do not have any `events` that overlap.
*/
readonly "reposCreateWebhook": (owner: string, repo: string, options: { readonly params?: typeof ReposCreateWebhookParams.Encoded | undefined; readonly payload: typeof ReposCreateWebhookRequest.Encoded }) => Effect.Effect<typeof Hook.Type, HttpClientError.HttpClientError | ParseError | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"ValidationError", typeof ValidationError.Type>>
  /**
* List all notifications for the current user, sorted by most recently updated.
*/
readonly "activityListNotificationsForAuthenticatedUser": (options?: typeof ActivityListNotificationsForAuthenticatedUserParams.Encoded | undefined) => Effect.Effect<typeof ActivityListNotificationsForAuthenticatedUser200.Type, HttpClientError.HttpClientError | ParseError | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"ValidationError", typeof ValidationError.Type>>
  /**
* Marks a thread as "read." Marking a thread as "read" is equivalent to clicking a notification in your notification inbox on GitHub: https://github.com/notifications.
*/
readonly "activityMarkThreadAsRead": (threadId: string, options?: typeof ActivityMarkThreadAsReadParams.Encoded | undefined) => Effect.Effect<void, HttpClientError.HttpClientError | ParseError | GitHubClientError<"BasicError", typeof BasicError.Type>>
  /**
* Lists repositories that the authenticated user has explicit permission (`:read`, `:write`, or `:admin`) to access.
* 
* The authenticated user has explicit permission to access repositories they own, repositories where they are a collaborator, and repositories that they can access through an organization membership.
*/
readonly "reposListForAuthenticatedUser": (options?: typeof ReposListForAuthenticatedUserParams.Encoded | undefined) => Effect.Effect<typeof ReposListForAuthenticatedUser200.Type, HttpClientError.HttpClientError | ParseError | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"BasicError", typeof BasicError.Type> | GitHubClientError<"ValidationError", typeof ValidationError.Type>>
}
